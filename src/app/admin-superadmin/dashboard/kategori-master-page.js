...
class KategoriMasterPage extends Component {
    ...
    showDeleteConfirm = (id,nama_kategori) => {
        confirm({
            title: `Apakah yakin untuk menghapus kategori ${nama_kategori} ?`,
            okText: 'Ok',
            okType: 'danger',
            cancelText: 'Batal',
            onOk: () => {
            ...
            },
            {
              ...
              render: (data) => (
                ...
                <ButtonEdit
                    ...
                    borderRadius="5px"
                    background="#E11212"
                    onClick = { () => this.showDeleteConfirm(data.nomor,data.nama_kategori)}
                />]
              ),
            },
          ];
